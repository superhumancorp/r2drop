...
- CI desktop release archive/export passes `DEVELOPMENT_TEAM`, the resolved Developer ID Application identity, and `teamID` explicitly so exported archives contain team metadata.
