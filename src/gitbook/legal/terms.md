...
R2Drop is free, open-source software released under the **MIT License**. You may use, copy, modify, merge, publish, distribute, sublicense, and/or sell copies of the software.

Source: [github.com/superhumancorp/r2drop](https://github.com/superhumancorp/r2drop)
...
- Your Cloudflare account, API tokens, and R2 bucket configuration
- All storage and egress costs billed to your Cloudflare account
- The content you upload via R2Drop

Do not use R2Drop to upload content that violates any law, infringes intellectual property rights, or contains malware.
