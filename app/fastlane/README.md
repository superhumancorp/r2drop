...
```sh
[bundle exec] fastlane mac build_local_dmg
```

Build local DMG release artifacts (arm64 + x86_64), optionally notarized

### mac dmg_release

```sh
[bundle exec] fastlane mac dmg_release
```

Alias for build_local_dmg
